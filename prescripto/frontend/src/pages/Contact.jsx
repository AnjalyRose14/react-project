...
const Contact = () => {
  return (
    <div>
      ...
      <p> CONTACT <span className='text-gray-700 fony-medium'>US</span></p>
    </div>  
    ...
    <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
      ...
      <div className='flex flex-col justify-center items-start gap-6'>
        <p className='font-medium text-lg text-gray-600'>OUR OFFICE</p>
        <p className='text-gray-500'>54709 Willms Station <br />Suite 350, Washington, USA</p>
        <p className='text-gray-500'>Tel:(415)555‑0132 <br /> Email:greatstackdev@gmail.com</p>
        <p className='font-medium text-lg text-gray-600'>Careers at PRESCRIPTO</p>
