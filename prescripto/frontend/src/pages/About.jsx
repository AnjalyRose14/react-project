...
const About = () => {
  return (
    ...
    <div className='text-md mt-18 mb-8 font-light text-gray-600'>
      <p>WHY <span className='text-gray-700 font-semibold'>CHOOSE US</span></p>
    </div>

    <div className='flex flex-col md:flex-row mb-20 '>
      <div className='border border-gray-300 pl-9 p-12 px-17 flex flex-col gap-5 text-xs hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer'>
        <b>EFFICIENCY:</b>
