            ...
            <div className='flex items-center gap-4'>
                {
                    token
                        ...
                        : <button onClick={() => navigate('/login')} className='bg-primary text-white px-5 py-2 rounded-full'>Create account</button>
                }
                <img onClick={() => setShowMenu(true)} className='w-6 md:hidden' src={assets.menu_icon} alt="" />

                {/* ----Mobile Menu---- */}
                <div className={`${showMenu ? 'w-full' : 'hidden'} md:hidden fixed right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
